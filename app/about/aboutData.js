const aboutData = [
    ...
    htmlcode: `<div class=" py-20 pb-32">
      <section>
        <div class=" lg:flex lge:flex md:block mdsm:block sm:block ">
          ...
          <div
            class=" lg:hidden lge:hidden md:block mdsm:block sm:block relative "
          >
            <div
              class=" bg-[#ede70e] absolute top-0 w-full h-[80%]"
            ></div>

            <img
              src="https://images.pexels.com/photos/1707823/pexels-photo-1707823.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="building"
              class=" h-[400px] relative z-20 w-[90%]  object-cover"
            />
          </div>

          <div class=" lg:w-[60%] lge:w-[60%] md:w-full mdsm:w-full sm:w-full lg:px-32 lge:px-32 md:px-20 mdsm:px-20 sm:px-10 py-20  bg-[#ede70e] relative">
            <div class=" absolute top-0 lg:w-[10%] lge:w-[10%] md:w-[5%] mdsm:w-[5%] sm:w-[5%] h-[86%] bg-[#333] left-0"></div>
            <h1 class=" text-5xl text-[#333]  font-semibold title-font">
              About us
            </h1>

            <p
              class=" text-base inter-font text-[#333]  font-semibold pt-4 text-justify"
            >
  ...
  },
  {
    ...
    htmlcode: `<section class="container  mx-auto px-4 py-20">
    
        <div class="py-20  grid lg:grid-cols-2 lge:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1 gap-10">
          <div>
            <h3 class="pt-14 text-5xl text-[#333533] font-semibold sm:text-4xl ">
              About us
            </h3>
            <p class="pt-6 text-[#333]  lg:w-[80%] lge:w-[80%] md:w-full  mdsm:w-full sm:w-full text-[18px] leading-7 text-justify">
            ...
            <p class="pt-2 text-[#333]  lg:w-[80%] lge:w-[80%] md:w-full   mdsm:w-full sm:w-full  text-[18px] leading-7 text-justify">
  ...
  },
  {
    ...
    htmlcode: `<section class="h-full container mx-auto px-6">
            <div class=" grid lg:grid-cols-5 lge:grid-cols-5 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1 lg:gap-10 lge:gap-10 md:gap-0 mdsm:gap-0 sm:gap-0">
              <div class="h-full  col-span-3">
                <div>
                  <h2 class="pt-0 text-4xl  font-semibold text-[#720026] ">
                    About us
                  </h2>
                  <p class=" dark:text-[#fcfcfc] text-[#333]  leading-7 pt-2 pb-6 text-1xl">
                  ...
                  <div class=" grid grid-cols-2 sm:grid-cols-1 gap-10">
                    <div>
                      ...
                      <p class="text-[#333] dark:text-[#fcfcfc] leading-7 pt-2">
                        Lorem ipsum is placeholder text commonly used in the
                        graphic, print
                      </p>
                    </div>
                  ...
                  <img
                    src="https://makecomponents.com/Image/overall/person/person005.webp"
                    class="w-full lg:mt-0 object-cover lg:hidden lge:hidden md:block mdsm:block sm:block lge:mt-0 md:mt-12 mdsm:mt-12 sm:mt-10"
                    alt="Gym"
                  />
                  <button class=" hover:bg-[#333] duration-700  mt-10 bg-[#720026] px-16 py-2 text-[#fcfcfc]">
                    Read More
                  </button>
                </div>
              </div>
              <div class="h-full  col-span-2 lg:block lge:block md:hidden mdsm:hidden sm:hidden">
                <img
                  src=".https://makecomponents.com/Image/overall/person/person005.webp"
                  class="w-full h-full object-cover lg:mt-0  lge:mt-0 md:mt-12 mdsm:mt-12 sm:mt-10"
                  alt="Gym"
                />
              </div>
            </div>
  ...
  },
  {
    ...
    htmlcode: `      <div className="bg-[#16325B] py-20">
