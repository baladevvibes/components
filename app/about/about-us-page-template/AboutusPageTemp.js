...
export default function AboutusPageTemp() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: aboutData[4]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: aboutLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`About Us page template: tailwind css. It is fully responsive, and it is good for the product base design.`}
          section_name={`About`}
          using_font=" Mulish, REM-font  "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/about/about-us-page-template/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                  ...
                  <div className="  dark:bg-[#1e1e1e]">
                    <section className="container  mx-auto px-4 py-20">
                      ...
                      >
                        <div>
                          <h3
                            className={`pt-14 ${xlScreen ? `text-5xl` : ``} ${
                              lgScreen ? `text-5xl` : ``
                            } ${mdScreen ? `text-5xl` : ``} ${
                              smScreen ? `text-4xl` : ``
                            }   ${
                              responsiveState ? `` : `text-5xl sm:text-4xl`
                            } text-[#333533] font-semibold REM-font  dark:text-[#F5CB5C] `}
                          >
                            About us
                          </h3>
                          <p
                            className={`pt-6 text-[#333] Mulish ${
                              xlScreen ? `w-[80%]` : ``
                            } ${lgScreen ? `w-[80%]` : ``} ${
                              mdScreen ? `w-full` : ``
                            } ${smScreen ? `w-full` : ``} ${
                              responsiveState
                                ? ``
                                : `lg:w-[80%] lge:w-[80%] md:w-full   mdsm:w-full sm:w-full`
                            }  text-[18px] leading-7 text-justify dark:text-[#e6e6e6]`}
                          >
                          ...
                          <p
                            className={`pt-2 text-[#333] Mulish ${
                              xlScreen ? `w-[80%]` : ``
                            } ${lgScreen ? `w-[80%]` : ``} ${
                              mdScreen ? `w-full` : ``
                            } ${smScreen ? `w-full` : ``} ${
                              responsiveState
                                ? ``
                                : `lg:w-[80%] lge:w-[80%] md:w-full   mdsm:w-full sm:w-full`
                            }  dark:text-[#e6e6e6] text-[18px] leading-7 text-justify`}
                          >
                            ex ea commodo consequat. Duis aute irure dolor in
                            reprehenderit in voluptate velit esse cillum dolore
                        ...
                        <div className=" flex justify-end relative">
                          <div className=" h-[80px] w-[80px]  bg-[#F5CB5C] text-4xl flex justify-center items-center  rounded-full absolute top-6 left-28 text-[#333533] font-semibold milonga-font">
                            25
                            <sup className=" text-[16px] mb-6 milonga-font">
                              +
                            </sup>
                          </div>
