...
export default function TailwindAboutUs() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Tailwind CSS About Us page and with clean design and proper color code. It is fully responsive.`}
          section_name={`About`}
          using_font="Comic , Dm-sans "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                ...
                <div  onClick={handleCode} className={` group`}>
                  ...
                  <a href={`/about/tailwind-css-about-us-page/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                        ...
                        <div>
                          <img
                            ...
                            className={`mx-auto h-[400px] w-[400px] ${
                              ...
                              responsiveState
                                ? ``
                                : `lge:block lg:block md:hidden mdsm:hidden sm:block`
                            } `}
                            alt="meeting"
                          />
                        </div>
