...
export default function TailwindAboutUsPageFree() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Tailwind About us page free and with clean design and proper color code. It is fully responsive.`}
          section_name={`about `}
          using_font="Kanit font,DM,sanf"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/about/tailwind-about-us-page-free/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                ...
                >
                  <div className="bg-[#16325B] py-20">
                    <div className=" container mx-auto">
                      <div className={`grid  ${xlScreen?`grid-cols-2`:``}  ${lgScreen?`grid-cols-2`:``}   ${mdScreen?`grid-cols-1`:``} ${smScreen?`grid-cols-1`:``} ${responsiveState?``:`lg:grid-cols-2 lge:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1 `}  gap-10 px-6`}>
                        <div>
                        ...
                        <div>
                          ...
                          <button    onClick={(e) => {
                                    ...
                                    window.location.href =
                                      "http://makecomponents.com/about/tailwind-about-us-page-free";
