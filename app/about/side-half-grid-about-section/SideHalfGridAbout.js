            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  <a href="/about/side-half-grid-about-section/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                      ...
                      <section>
                        <div
                          className={` ${xlScreen ? `flex` : ``} ${
                            ...
                            responsiveState
                              ? ``
                              : `lg:flex lge:flex md:block mdsm:block sm:block `
                          } `}
                        >
                          <div
                          ...
                          <div
                            className={` ${xlScreen ? `w-[60%] px-32` : ``} ${
                              lgScreen ? `w-full px-32` : ``
                            } ${mdScreen ? `w-full px-24` : ``} ${
                              smScreen ? `w-full px-20` : ``
                            } ${
                              responsiveState
                                ? ``
                                : `lg:w-[60%] lge:w-[60%] md:w-full mdsm:w-full sm:w-full lg:px-32 lge:px-32 md:px-20 mdsm:px-10 sm:px-10`
                            }  py-20  bg-[#ede70e] relative`}
                          >
                            <div className=" absolute top-0 lg:w-[10%] lge:w-[10%] md:w-[5%] mdsm:w-[5%] sm:w-[5%] h-[86%] bg-[#333] left-0"></div>
                            <h1
                              className={` text-5xl text-[#333]  font-semibold title-font`}
                            >
                              About us
                            </h1>
                            ...
                            >
                              Welcome to construction company! Since our
                              founding in 1984, we have been dedicated to
                              Engineerings of some group. As a leading provider
                              of services in the industry, we pride ourselves on
                              delivering high-quality solutions that meet the
                              unique needs of our diverse clientele. Our team of
                              experienced professionals is committed to
                              innovation, excellence, and exceptional customer
                              service, ensuring that every interaction with our
                              company is a positive one.
                            </p>

                            <p
                              className={` text-base inter-font text-[#333]  font-semibold pt-4 text-justify`}
                            >
                              We are constantly evolving and expanding to better
                              serve our customers and stay ahead in a
                              competitive market. Thank you for choosing
                              company; we look forward to helping you achieve
                              your goals with our top-notch services.
                            </p>
                          </div>
                        </div>
                      </section>
