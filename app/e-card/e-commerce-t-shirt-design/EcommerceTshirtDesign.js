...
export default function EcommerceTshirtDesign() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`E-commerce t-shirt design with clean design and proper color code. It is fully responsive.`}
          section_name={`e-card `}
          using_font="DM san"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/e-card/e-commerce-t-shirt-design/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
                    ...
                    <div className="container mx-auto px-4">
                      <div
                        className={`grid ${xlScreen ? `grid-cols-4` : ``} ${
                          ...
                          responsiveState
                            ? ``
                            : `lg:grid-cols-4  lge:grid-cols-4 md:grid-cols-3 mdsm:grid-cols-2 sm:grid-cols-1`
                        }  gap-10`}
                      >
                        <div>
              <div className="bg-[#9ec4ef]   group cursor-pointer relative flex justify-center">
                ...
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class=" group-hover:text-[#003b80]  cursor-pointer text-[#ffff] text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"></path></svg>
                </div>
              </div>
