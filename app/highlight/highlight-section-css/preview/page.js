...
import HighLightSectionCssPre from './HighLightSectionCssPre'
export const metadata = {
  keywords:
    "highlight section css example preview in html, highlight section css example preview, highlight in css",
  description:
  ...
  openGraph: {
    title: "highlight section css example preview",
    description:
      "highlight section CSS example and with clean design and proper color code. It is fully responsive.",
    ...
    images: [
      ...
      },
      {
        ...
        width: 800,
        height: 600,
        alt: "highlight section css example preview",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  title: {
    default: "highlight section css example preview",
  },
  alternates: {
    canonical: "https://makecomponents.com/highlight/highlight-section-css",
  },
...
export default function page() {
  const jsonLd = {
    ...
    "@type": "BreadcrumbList",
    name: "highlight section css example preview",
    itemListElement: [
      {
        "@type": "ListItem",
        position: 1,
      ...
      },
      {
        ...
        position: 3,
        name: "highlight section css example preview",
        item: "https://makecomponents.com/highlight/highlight-section-css/preview",
      },
    ],
  };
  return (
