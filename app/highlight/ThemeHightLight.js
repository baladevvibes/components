const ThemeHightLight = [
    {
        ...
        htmlcode:`<div className=" py-[100px] dark:bg-[#1e1e1e]">
      <div className="] relative bg-[url(https://makecomponents.com/Image/overall/building/building4.webp)] bg-hero bg-no-repeat bg-cover bg-center bg-fixed">
