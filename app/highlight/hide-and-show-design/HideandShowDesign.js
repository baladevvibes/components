...
import highlight from "../highLightData";
...
export default function HideandShowDesign() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: highlight[2]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: ThemeHightLight[1]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Hide and show design tailwind css like faq and showing reslative images. It fully responsive.`}
          section_name={`highlight`}
          using_font="Exo 2, sans-serif "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/highlight/hide-and-show-design/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <div className="py-32 dark:bg-[#1e1e1e]">
                   
                  <section className={`${xlScreen? `block`: ``} ${lgScreen? `block`: ``} ${mdScreen? `hidden`: ``} ${smScreen? `hidden`: ``} ${responsiveState? ``:` lg:block lge:block md:hidden mdsm:hidden sm:hidden`} `}>
      ...
      <section className={` ${xlScreen? `hidden`: ``} ${lgScreen? `hidden`: ``}  ${mdScreen? `block`: ``} ${smDevice? `block`: ``} ${responsiveState? ``:` lg:hidden lge:hidden md:block mdsm:block sm:block`} `}>
        <div className=" container px-4 mx-auto">
          <div className={`grid ${xlScreen? ` grid-cols-4`: ``}  ${lgScreen? ` grid-cols-3`: ``} ${mdScreen? ` grid-cols-2`: ``} ${smScreen? ` grid-cols-1`: ``} ${responsiveState? ``: `lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 `}  gap-10`}>
