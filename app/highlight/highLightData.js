        ...
        <section>
          <div class=" grid lg:grid-cols-2  lge:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1">
            ...
            <div class=" lg:py-20 lge:py-20 md:py-10 mdsm:py-10 sm:py-10 px-4">
              <h1 class="text-4xl text-[#00333d] font-semibold">Get the Best Home Design Tips! </h1>
              ...
              <input type="text" placeholder=" Get in touch" class=" text-[#333] w-[50%] outline-none px-4 py-3 border	 border-[#fff] "/>
                <button class="bg-[#00333d] py-3 px-16 mx-10 hover:border hover:border-[#00333d] hover:bg-[#fff] hover:text-[#00333d] text-[#fff]">Subscribe</button>
              </div>
            </div>
          </div>
        </section>
