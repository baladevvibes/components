...
export default function HighLightCapture() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: highlightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 1,
      name: "index.css",
  ...
  useEffect(() => {
    setCount(1);
    var removeComponents = "017";
    var tagName = "news-letter";
    var newData = [];
    data.forEach((el) => {
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  <a href="/highlight/highlight-capture/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                          ...
                          >
                            <div className=" relative">
                              <img
                                ...
                                className={`mx-auto ${
                                  xlScreen
                                    ? `h-[500px] w-[500px]   absolute -top-20`
                                    : ``
                                } ${
                                  lgScreen
                                    ? `h-[500px] w-[500px]   absolute -top-20`
                                  ...
                                  mdScreen
                                    ? `h-[400px] w-[400px]  relative top-0`
                                    : ``
                                } ${
                                  smScreen
                                    ? `h-[400px] w-[400px]  relative top-0`
                                  ...
                                  responsiveState
                                    ? ``
                                    : `lg:-top-20 lge:-top-20 md:top-0 mdsm:top-0 sm:top-0 lg:h-[500px] lg:w-[500px] lge:h-[500px] lge:w-[500px] md:h-[500px] md:w-[500px] mdsm:h-[400px] mdsm:-[400px] sm:h-[400px] sm:w-[400px] h-[500px] w-[500px]  md:relative lg:absolute lge:absolute  mdsm:relative sm:relative`
                                }    object-cover`}
                              />
                            </div>
                            <div
                              className={` ${xlScreen ? `py-20` : ``} ${
                                lgScreen ? `py-20 pb-32` : ``
                              } ${mdScreen ? `py-10` : ``} ${
                                smScreen ? `py-10` : ``
                              } ${
                                responsiveState
                                  ? ``
                                  : `lg:py-20 lge:py-20 md:py-10 mdsm:py-10 sm:py-10`
                              }   px-4`}
                            >
                              <h1 className="dosis-font text-4xl text-[#00333d] font-semibold">
                                Get the Best Home Design Tips!{" "}
                              </h1>
                              <p className="varela-font  text-[20px] pt-6 text-[#001e24]">
                                Transform your living space with expert advice
                                and stay ahead with the latest trends. Join our
                                community today!
                              </p>
                              <div className="mt-4 flex pt-4">
                                <input
                                  ...
                                  className="varela-font text-[#333] w-[50%] outline-none px-4 py-3 border	 border-[#fff] "
                                />
                                <button className="bg-[#00333d] varela-font py-3 px-16 mx-10 hover:border hover:border-[#00333d] hover:bg-[#fff] hover:text-[#00333d] text-[#fff]">
                                  Subscribe
                                </button>
                              </div>
                            </div>
