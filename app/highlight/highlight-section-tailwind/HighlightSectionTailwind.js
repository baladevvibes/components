...
export default function HighlightSectionTailwind() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: highlight[1]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: ThemeHightLight[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Highlight section background is sticky, and scroll means content only moves. It's a fully icon- and content-based design for the highlight area.`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/highlight/highlight-section-tailwind/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                      ...
                      <div className=" relative bg-[url(/Image/overall/building/building4.webp)] bg-hero bg-no-repeat bg-cover bg-center bg-fixed">
                        <div className=" py-[70px]  dark:bg-[#393939f2] bg-[#ff0014c9]">
                          <div className=" container px-4 mx-auto">
                            <div className={` grid  ${xlScreen? `grid-cols-4`:``}  ${lgScreen? `grid-cols-4`:``} ${mdScreen? `grid-cols-2`:``} ${smDevice? `grid-cols-1`:``} ${responsiveState? ``: `lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 `} gap-10`}>
                              <div className=" group">
