            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  <a href={`/subscribe-newsletter/subscribe-newsletter-attraction/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                  ...
                  <section>
                    <div className=" my-40 container mx-auto px-4">
                      <div className=" bg-[#0f67f5] overflow-hidden py-10  px-10 rounded-lg relative">
                        ...
                        <div className={` grid  ${xlScreen? ` grid-cols-3`: ``} ${lgScreen? ` grid-cols-1`: ``} ${mdScreen?` grid-cols-1`: ``} ${smScreen? `grid-cols-1`: ``} ${responsiveState ? ``: `lg:grid-cols-3 lge:grid-cols-3 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1`} `}>
                          ...
                          <div>
                            <div className={` relative ${xlScreen? `mt-0`:``} ${lgScreen? `mt-2`: ``} ${mdScreen? `mt-4`: ``} ${smScreen? ` mt-4`:``} ${responsiveState? `lg:mt-0 lge:mt-0 md:mt-4 mdsm:mt-4 sm:mt-4`: ``}  `}>
                              <form>
