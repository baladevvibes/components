           ...
           <div class=" border border-[#e2e2e2]  rounded-lg ">
             <div class="group grid  md:grid-cols-3  mdsm:grid-cols-1 sm:grid-cols-1">
               ...
               <div class=" col-span-2 px-4 py-4">
                 <h2 class=" text-2xl text-[#1e1e1e] leading-6  font-semibold">
                   Own satellites against US
                 </h2>
                 <p class="pt-2  leading-6  text-[#424242]">
          ...
          <div className="   relative lg:w-[40%] lge:w-[40%] md:w-[60%] mdsm:w-[90%] sm:w-full mx-auto">
            ...
            <div className="flex mb-2 w-full">
              ...
              <div className=" border-b-[1px] border-t-[1px] border-r-[1px]  border-[#ccc]  relative px-4 flex w-[80%]">
                <div className=" block">
                  <div className=" py-1 pt-2    px-2 text-left">
                    Lorem ipsum is placeholder.
                  </div>
                  <div className=" text-[#26547C]     px-2 text-left">
                    Alumni
                  </div>
                </div>
