...
import blogLightData from "../blogLightData";
...
export default function BlogCardDesign() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: blogData[0]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: blogLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Blog card design tailwind css. It use for the blog card section.`}
          section_name={`card`}
          using_font="  Anek Tamil, varela-round"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/blog/blog-card-design/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <section className=" dark:bg-[#1e1e1e] container mx-auto px-4 py-40">
                    <div
                      className={`grid ${xlScreen ? `grid-cols-2` : ``} ${
                        lgScreen ? `grid-cols-1 px-28` : ``
                      } ${mdScreen ? `grid-cols-1 px-20` : ``} ${
                      ...
                      <div className=" border border-[#e2e2e2] dark:border-[#454545] rounded-lg ">
                        <div
                          className={`group grid ${
                            ...
                            responsiveState
                              ? ``
                              : `md:grid-cols-3 mdsm:grid-cols-1 sm:grid-cols-1`
                          } `}
                        >
                          <div
                            className={`overflow-hidden ${
                              xlScreen
                                ? `rounded-tl-lg rounded-bl-lg rounded-tr-none`
                                : ``
                            } ${
                              lgScreen
                                ? `rounded-tl-lg rounded-bl-lg rounded-tr-none`
                              ...
                              mdScreen ? `rounded-tl-lg rounded-tr-lg` : ``
                            }  ${
                              smScreen ? `rounded-tl-lg rounded-tr-lg` : ``
                            } ${
                              responsiveState
                                ? ``
                                : `md:rounded-tl-lg md:rounded-bl-lg md:rounded-tr-none mdsm:rounded-tl-lg mdsm:rounded-tr-lg sm:rounded-tl-lg sm:rounded-tr-lg`
                            }   `}
                          >
                            <img
                              ...
                              className={`${
                                ...
                                responsiveState
                                  ? ``
                                  : `md:rounded-tl-lg md:rounded-bl-lg md:rounded-tr-none mdsm:rounded-tl-lg mdsm:rounded-tr-lg sm:rounded-tl-lg sm:rounded-tr-lg`
                              }  object-cover group-hover:scale-125 h-[200px] w-full duration-700`}
                            />
                          </div>
                          <div className=" col-span-2 px-4 py-4">
                            <h2 className=" text-2xl text-[#1e1e1e] leading-6 Anek-Tamil font-semibold dark:text-[#f2f2f2]">
                              Own satellites against US
                            </h2>
                            <p className="pt-2 varela-round-font dark:text-[#9b9b9b]   leading-6  text-[#424242]">
                              They're using our own satellites against us. And
                              the clock is ticking. This thing comes fully
                              loaded. AM/FM radio.
                            </p>
