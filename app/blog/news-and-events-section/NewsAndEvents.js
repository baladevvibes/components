    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`simple news and events section. This section is simple, professional, and good. The changes are all done in the block section and landing page.`}
          section_name={`blog`}
          using_font="  Jost, varela-round"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/blog/news-and-events-section/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <section className=" dark:bg-[#1e1e1e] ">
                    <div className="py-32">
                      <section className=" container px-4 mx-auto">
                        <div
                          className={`   relative ${
                            ...
                            responsiveState
                              ? ``
                              : ` lg:w-[40%] lge:w-[40%] md:w-[60%] mdsm:w-[90%] sm:w-full`
                          } mx-auto`}
                        >
