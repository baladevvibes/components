    ...
    <div>
      ...
      <div className={`grid grid-cols-3 h-[100vh] overflow-hidden relative`}>
            ...
            <div className={` grid grid-cols-12`}>
              ...
              >
                <div className={` relative`}>
                  ...
                  <div className={`lg:hidden lge:hidden md:hidden mdsm:block sm:block absolute top-4 right-4 flex justify-end`}>
        ...
        <div className="bg-[#181818] lg:block lge:block md:hidden mdsm:hidden sm:hidden h-full relative">
          ...
          <div className={` px-4 flex justify-center items-center h-full  lg:mt-6 lge:mt-0 ml-24 z-10`}>
            <div className={` block`}>
