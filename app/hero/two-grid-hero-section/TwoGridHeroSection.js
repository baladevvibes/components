    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`This is a hero session. Two grid-based concepts and designs for a clothing products company. It is fully responsive.`}
          section_name={`Hero`}
                ...
                >
                  <section className={` `}>
                    <div className={` py-20`}>
                      <header>
                        <div
                          className={`grid grid-cols-3 h-[100vh] overflow-hidden relative`}
                        >
                            ...
                            <div className={` container mx-auto`}>
                              <div className={` grid grid-cols-12`}>
                                <div
                                  className={`  ${
                                    xlScreen ? ` col-span-4` : ``
                                  } ${lgScreen ? `col-span-full` : ``} ${
                                    mdScreen ? ` col-span-full` : ``
                                  } ${smScreen ? ` col-span-full` : ``} ${
                                    responsiveState
                                      ? ``
                                      : `lg:col-span-4 lge:col-span-4 md:col-span-4 mdsm:col-span-full sm:col-span-full`
                                  }  px-4`}
                                >
                                  <div className={` relative`}>
                                    <div
                                      className={`pt-2 cinzel-font ${
                                        xlScreen
                                          ? ` text-5xl text-[#fff] text-left`
                                          : ``
                                      } ${
                                        lgScreen
                                          ? ` text-5xl text-[#181818] text-left`
                                          : ``
                                      } ${
                                        mdScreen
                                          ? ` text-5xl text-left text-[#181818] `
                                          : ``
                                      } ${
                                        smScreen
                                          ? ` text-left  text-[#181818] text-3xl`
                                          : ``
                                      } ${
                                        responsiveState
                                          ? ``
                                          : `lg:text-[#fff] lge:text-[#fff] md:text-[#181818] mdsm:text-[#181818] sm:text-[#181818] lg:text-5xl lge:text-5xl md:text-5xl mdsm:text-5xl sm:text-3xl lg:text-left lge:text-left md:text-left mdsm:text-left sm:text-left  `
                                      }  font-semibold  `}
                                    >
                                      Logo
                                    </div>
                                    <div
                                      className={` ${
                                        xlScreen ? `hidden` : ``
                                      } ${lgScreen ? `block w-full ` : ``} ${
                                        mdScreen ? `block` : ``
                                      }  ${smScreen ? `block` : ``} ${
                                        responsiveState
                                          ? ``
                                          : `lg:hidden lge:hidden md:hidden mdsm:block sm:block`
                                      } w-full absolute top-4 right-4 flex justify-end`}
                                    >
                                      <svg
                                        stroke="currentColor"
                                        fill="currentColor"
                                ...
                                >
                                  ...
                                  >
                                    <div
                                      className={`  flex space-x-16 justify-end px-4 py-4`}
                                    >
                                      <div
                          ...
                          >
                            ...
                            <div
                              className={` px-4 flex justify-center items-center h-full  ${
                                ...
                                responsiveState ? `` : ` lg:mt-6 lge:mt-0`
                              }  ml-24 z-10`}
                            >
                              <div className={` block`}>
                          ...
                          <div
                            className={` ${xlScreen ? `col-span-2` : ``} ${
                              ...
                              responsiveState
                                ? ``
                                : `lg:col-span-2 lge:col-span-2 md:col-span-full mdsm:col-span-full sm:col-span-full`
                            }  h-full relative`}
                          >
                            <div
                                ...
                                <div className={` block`}>
                                  <h1
                                    className={` text-[#181818]  ${
                                      xlScreen ? `mt-6 text-[50px]` : ``
                                    } ${lgScreen ? `mt-10 text-[30px]` : ``} ${
                                      mdScreen ? `text-[30px]` : ``
                                    } ${smScreen ? `text-[30px]` : ``} ${
                                      responsiveState
                                        ? ``
                                        : `lg:text-[50px] lge:text-[50px] md:text-[30px] mdsm:text-[30px] sm:text-[30px] lg:mt-6 lge:mt-10`
                                    }  relative   px-4    font-semibold cinzel-font `}
                                  >
                                    Clothes and T-shirts
                                  </h1>
                                  <p
                                    className={`pt-1 alegreya-font  text-[#333] font-semibold text-justify ${
                                      xlScreen ? `text-[24px] w-[70%] ` : ``
                                    } ${
                                      lgScreen ? `text-[20px] w-[90%] ` : ``
                                    } ${
                                      mdScreen ? ` text-[20px] w-[90%]` : ``
                                    } ${
                                      smScreen ? `w-[100%] text-[20px] ` : ``
                                    } ${
                                      responsiveState
                                        ? ``
                                        : `lg:text-[24px] lge:text-[24px] md:text-[24px] mdsm:text-[20px] sm:text-[20px] lg:w-[70%] lge:w-[70%] md:w-[90%] mdsm:w-[90%] sm:w-[100%]`
                                    }  px-4`}
                                  >
                                    Explore the latest trends in fashion with
                                    our exclusive collection of clothes and
                                    t-shirts. Whether you're looking for casual
                                    comfort or stylish elegance, we've got you
                                    covered.
                                  </p>
                                  <p
                                    className={`pt-1 alegreya-font  text-[#333] font-semibold text-justify ${
                                  ...
                                  >
                                    Stay ahead of the fashion curve with our
                                    weekly new arrivals. Each piece is designed
                                    with you in mind, blending comfort, quality,
                                    and style.
                                  </p>

                                  <button
                                    className={`alegreya-font ${
                                      xlScreen ? `text-[22px]` : ``
                                    }  ${lgScreen ? `text-[18px]` : ``} ${
                                      mdScreen ? `text-[18px]` : ``
                                    } ${smScreen ? `text-[16px]` : ``} ${
                                      responsiveState
                                        ? ``
                                        : `lg:text-[22px] lge:text-[22px] md:text-[22px] mdsm:text-[18px] sm:text-[16px]`
                                    }  font-semibold tracking-widest mx-4 bg-[#181818] text-base mt-4 hover:bg-[#fff] border-2 border-[#181818]  hover:font-semibold hover:text-[#181818] px-16 py-3 text-[#fff]`}
                                  >
                                    Shop Now
                                  </button>
                                </div>
