...
export default function TailwindBackground() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: heroData[4]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: ThemeHeroData[1]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Tailwind background section with gradient and color-fully. It gives a simple and professional section for tech.`}
          section_name={`Hero`}
          using_font=" Archivo, Work Sans"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/hero/tailwind-background-section/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <section className=" relative dark:bg-[#1e1e1e]">
                        ...
                        <div className="  w-[100%]">
                          <div className=" min-h-[100vh]   text-center flex justify-center items-center">
                            <div className=" block">
                              ...
                              <h3
                                className={` ${
                                  xlScreen ? `text-2xl w-[60%]` : ``
                                } ${lgScreen ? `text-2xl w-[60%]` : ``} ${
                                  mdScreen ? `text-2xl w-[80%]` : ``
                                } ${smScreen ? `text-[20px] w-full` : ``} ${
                                  responsiveState
                                    ? ``
                                    : `text-2xl sm:text-[20px] md:w-[60%] mdsm:w-[80%] sm:w-full`
                                }  dark:text-[#f2f2f2] text-[#434343]  mx-auto work pt-4`}
                              >
                                The Future of Technology Starts Here.Leading the
                                Way in{" "}
