...
function DashboardInfromation() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: dashBoardInfoData[1]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
  ...
  useEffect(() => {
    ...
    if (iframe) {
      iframe.srcdoc = dashBoardInfoData[1]?.htmlcode;
    }
  ...
  useEffect(() => {
    setCount(1);
    var removeComponents = "057";
    var tagName = "dashboard-info";
    var newData = [];
    data.forEach((el) => {
      ...
      <div className="bg-[rgb(255 255 255)]">
        ...
        <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
          <ComponentsHeader
            ...
            des={`Dashboard Information and with clean design and proper color code. It is fully responsive.`}
            section_name={`dashboard-info`}
            using_font="plus-jakarta-sans  ,concert-font"
          />
          ...
          >
            ...
            >
              ...
              {tailwind ? (
                ...
                <>
                  <div>
                    <div className={ ` lg:pt-32 lge:pt-32 md:pt-10 mdsm:pt-10 sm:pt-10 sm:pb-10  ${
                          xlScreen ? `h-[60vh]` : ``
                        }  ${lgScreen ? `h-[80vh]` : ``}  ${
                          mdScreen ? `h-[80vh]` : ``
                        } ${smScreen ? `h-[100vh]` : ``}  `}>
...
export default DashboardInfromation;
