              ...
              {tailwind ? (
                ...
                <>
                  ...
                  <div className="  container mx-auto py-32">
                    <div className={` ${xlScreen ? `w-[w-full]`:``} ${lgScreen ? `w-[980px]`:``} ${mdScreen ? `w-[780px]`:``} ${smScreen ? `w-[600px]`:``} ${responsiveState ? ``:` sm:w-[600px] md:w-[780px] lg:w-full lge:w-full mdsm:w-[980px]`} mx-auto`}>
