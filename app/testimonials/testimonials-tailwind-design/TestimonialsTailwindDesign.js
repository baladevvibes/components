...
export default function TestimonialsTailwindDesign() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Testimonials tailwind design and with clean design and proper color code. It is fully responsive.`}
          section_name={`Testimonials `}
          using_font="Mulish, acme-font"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/testimonials/testimonials-tailwind-design/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <div className="py-20 my-6 bg-[#990033]">
                      ...
                      >
                        <div className=" bg-[#ffffff]  relative shadow-xl px-10 rounded-3xl p-6">
                          <svg
                            ...
                            stroke-width="0"
                            viewBox="0 0 512 512"
                            class="text-5xl text-[#FF9000]  absolute right-6 top-4"
                            height="1em"
                            width="1em"
                            xmlns="http://www.w3.org/2000/svg"
                          >
