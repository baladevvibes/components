const ThemeTestimonialsData = [
  {
    ...
    htmlcode: `  <section class="container mx-auto py-[100px] px-4">
          <div class=" grid lg:grid-cols-4  lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 gap-10">
            <div class="bg-[#f2f2f2] dark:bg-[#313131] relative p-4 border-[#fff] dark:border-[#313131] border">
              ...
              <div class=" italic  dark:text-[#f2f2f2] text-[18px] pt-6  text-[#07172a]">
              ...
              <div class=" pt-10 flex pb-4 space-x-2">
                ...
                <div></div>
                <div>
                  <h3 class="font-semibold dark:text-[#f2f2f2]  pt-2 text-[#222] text-left  text-[16px]">
                    Williams
                  </h3>
                  <h3 class="font-normal  dark:text-[#f2f2f2] text-[#07172a]  text-[12px] text-left">
                    Founder
                  </h3>
                </div>
              </div>
...
export default ThemeTestimonialsData;
