...
export default function GallerySectionTailwind() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Gallery Section tailwind and with clean design and proper color code. It is fully responsive.`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/gallery/gallery-section-tailwind/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                ...
                >
                  <div className=" py-20">
                    <div className=" container mx-auto">
                      <div className={`grid ${xlScreen?`grid-cols-12 gap-2`:``} ${lgScreen?`grid-cols-12 gap-2`:``} ${mdScreen?`grid-cols-1 gap-0`:``} ${smScreen?`grid-cols-1 gap-0`:``} ${responsiveState?``:`lg:grid-cols-12  lge:grid-cols-12 md:grid-cols-1  mdsm:grid-cols-1 sm:grid-cols-1 lg:gap-2 lge:gap-2 md:gap-0 mdsm:gap-0 sm:gap-0`} `}>
                        ...
                        <div className={`col-span-6 ${xlScreen?`gap-2 pt-0`:``} ${lgScreen?`gap-2 pt-0`:``} ${mdScreen?`gap-0 pt-2`:``} ${smScreen?`gap-0 pt-2`:``} ${responsiveState?``:`lg:gap-2 lge:gap-2 md:gap-0 mdsm:gap-0 sm:gap-0 lg:pt-0 lge:pt-0 md:pt-2 mdsm:pt-2 sm:pt-2 `} `}>
                          <div className="h-[240px]">
                            <div className={` grid grid-cols-2  ${xlScreen?`gap-2`:``} ${lgScreen?`gap-2`:``} ${mdScreen?`gap-0`:``}  ${smScreen?`gap-0`:``} ${responsiveState?``:` lg:gap-2 lge:gap-2 md:gap-0 mdsm:gap-0 sm:gap-0`}`}>
                              <div>
                                <img
                              ...
                              <div>
                                <img
                                  ...
                                  alt="dog"
                                  className={`h-[240px]  w-full  object-cover ${xlScreen?`pl-0`:``} ${lgScreen?`pl-0`:``} ${mdScreen?`pl-2`:``} ${smScreen?`pl-2`:``} ${responsiveState?``:`lg:pl-0 lge:pl-0 md:pl-2 mdsm:pl-2 sm:pl-2`} `}
                                />
                              </div>
                            </div>
                          </div>
                        ...
                        <div className={`col-span-3 ${xlScreen?`mt-0`:``}  ${lgScreen?`mt-0`:``}  ${mdScreen?`mt-4`:``}  ${smScreen?`mt-4`:``}   ${responsiveState?``:`lg:mt-0 lge:mt-0 md:mt-4 mdsm:mt-4 sm:mt-4`} `}>
                          <img
