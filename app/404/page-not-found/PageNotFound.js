    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`This component create on 22/June/2024 using CSS framework tailwindcss. It fully
              responsive component.`}
          section_name={`404 Page`}
          using_font=" Milonga, DM Sans, sans-serif  "
        />
                    ...
                    <div className="py-24  container mx-auto px-4">
                      <section>
                        ...
                        <p className="text-[30px] font-semibold  text-center">
                          HERE THER IS{" "}
                          <span className=" bg-[#ccc]">NOTHING..</span>
                        </p>
                        <p className="text-[30px] font-semibold  text-center">
                          PAGE NOT FOUND..
                        </p>
