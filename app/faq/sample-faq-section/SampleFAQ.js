...
export default function SampleFAQ() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: faqData[0]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: faqLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`This is a very simple faq design. But look at the at the high-level rich class. It will be very easy to handle and use for the design.`}
          section_name={`FAQ`}
          using_font="Rowdies, DM Sans, sans-serif"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/faq/sample-faq-section/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                    ...
                    <section className=" container px-4 py-40   mx-auto">
                      ...
                      <div
                        className={` ${xlScreen ? `w-[50%]` : ``} ${
                          ...
                          responsiveState
                            ? ``
                            : `lg:w-[50%] lge:w-[50%] md:w-[80%] mdsm:w-[80%] sm:w-[100%]`
                        }  mx-auto`}
                      >
                        <details class="group  border-b-[1px] border-b-[#ccc] pb-2">
                          ...
                          <p class="mt-3 text-[#5a5a5a] dark:text-[#c0c0c0] leading-7">
                            A perfect spot for picnics, strolls, and enjoying
                            nature.
                          </p>
                        </details>
                        ...
                        <details class="group  border-b-[1px] border-b-[#ccc] pb-2">
                          ...
                          <p class="mt-3 text-[#5a5a5a] dark:text-[#c0c0c0]  leading-7">
                            Ride-Sharing and Taxis: Easily accessible for quick
                            trips.
                          </p>
                        </details>
                        ...
                        <details class="group  border-b-[1px] border-b-[#ccc] pb-2">
                          <summary class="flex mt-4  cursor-pointer list-none items-center justify-between font-medium">
                            <span className="text-[#434343] font-semibold dark:font-normal dark:text-[#c0c0c0] leading-7">
                              {" "}
                              Are there any local customs or etiquette I should
                              be aware of?
                            </span>
                            <span class="transition group-open:rotate-180">
                              <svg
                          ...
                          <p class="mt-3 text-[#5a5a5a] dark:text-[#c0c0c0] leading-7">
                            Be mindful of noise levels and personal space in
                            public areas.
                          </p>
                        </details>
                      </div>
