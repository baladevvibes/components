    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Tailwind table is responsive and easy to user experience for the see the data values.`}
          section_name={`table`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/table/responsive-table/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <section className=" container mx-auto dark:bg-[#1e1e1e] py-10 ">
                    <div className=" sm:w-full overflow-auto px-4">
                      <table
                        className={` ${xlScreen ? `w-[80%]` : ``}  ${
                          lgScreen ? `w-[80%]` : ``
                        }  ${mdScreen ? `w-full` : ``} ${
                          smScreen ? `w-full` : ``
                        } ${
