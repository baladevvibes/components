...
export const metadata = {
    ...
    openGraph: {
      ...
      description:
        "Tailwind table is responsive and easy to user experience for the see the data values.",
      url: "https://makecomponents.com/table/responsive-table",
      siteName: "makecomponents.com",
      alternates: {
        canonical: `https://makecomponents.com/table/responsive-table`,
      },
      images: [
        {
    ...
    metadataBase: new URL(`https://makecomponents.com/table/responsive-table`),
    title: {
      default: `Tailwind table responsive`,
    },
    alternates: {
      canonical: "https://makecomponents.com/table/responsive-table",
    },
