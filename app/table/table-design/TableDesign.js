...
import tableLightData from "../TableLightData";
...
export default function TableDesign() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: tableData[2]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: tableLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Table design in HTML examples and with clean design and proper color code. It is fully responsive.`}
          section_name={`table`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                ...
                <div  onClick={handleCode} className={` group`}>
                  ...
                  <a href={`/table/table-design/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                  ...
                  <div class="py-20">
                    <section class="container mx-auto">
                      <div class="sm:w-full overflow-auto px-4">
                        <table class={` ${xlScreen?`w-full`:``} ${lgScreen?`w-[100%]`:``} ${mdScreen?`w-[140%]`:``} ${smScreen?`w-[200%]`:``} ${responsiveState?``:`sm:w-[200%] md:w-[150%] mdsm:w-[150%] lge:w-full lg:w-full`}  mx-auto`}>
                          <thead>
                            <tr className="  text-[#333]  font-bold border-b border-[#ccc]">
                              <td className=" sm:w-[100px] px-4 py-4">
                                Order ID
                              </td>
                              <td>Customer Name</td>
                              <td>Product</td>
                          ...
                          <tbody>
                            ...
                            <tr className="group cursor-pointer hover:bg-[#ecf1f4] text-[14px]  text-[#333]  border-b border-[#ccc]">
                              <td className="px-4 font-bold py-4">#54106</td>
