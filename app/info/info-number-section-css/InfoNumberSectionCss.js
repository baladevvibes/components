...
function InfoNumberSectionCss() {
  ...
  useEffect(() => {
    ...
    if (iframe) {
      iframe.srcdoc = InfoData[2]?.htmlcode;
    }
      ...
      <div className="bg-[rgb(255 255 255)]">
        ...
        <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
          <ComponentsHeader
            ...
            des={`Info Design css and with clean design proper color code. It fully responsive.`}
            section_name={`info`}
            using_font="rowdies  ,raleway-font"
          />
          ...
          >
            ...
            >
              ...
              {tailwind ? (
                ...
                <>
                  <div>
                    <div className={ ` lg:pt-32 lge:pt-32 md:pt-10 mdsm:pt-10 sm:pt-10 h-[100vh] `}>
                      <iframe
                        ref={iframeRef}
                        id="iframeRef"
                        title="Live Preview"
...
export default InfoNumberSectionCss;
