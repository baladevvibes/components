...
export default function InfoNumberSectionCss() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: infoData[2]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: infoLightData[1]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    "bootstrapIndex.html": {
      ...
      language: "html",
      value: bootStrapHtml[1]?.htmlcode,
    },
    "bootstrapStyleSheet.css": {
      _id: 5,
      name: "bootstrapStyleSheet.css",
      language: "css",
      value: bootStrapCSS[1]?.stylecode,
    },
  };
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`info number section css design example and with clean design and proper color code. It is fully responsive.`}
          section_name={`info`}
          using_font="rowdies "
        />
      ...
      <img src="../../Image/overall/svg/background-path.svg" alt=" " className="h-full w-full object-cover absolute top-0"/>
        <section className="py-20 container mx-auto">
            <div className={`grid ${xlScreen? `grid-cols-4`:``} ${lgScreen? `grid-cols-4`:``} ${mdScreen? `grid-cols-2`:``} ${smScreen? `grid-cols-1`:``} ${responsiveState? ``:`lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1`} `}>
                <div>
