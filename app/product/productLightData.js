    ...
    htmlcode: `   <section>
        <div className=" grid py-40 lg:grid-cols-2 lge:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1">
          <div className=" bg-[#8fa8ae] dark:bg-[#151515] py-20 px-10 overflow-hidden relative ">
            ...
            />
            <div>
              <h2 className=" text-5xl  dark:text-[#f2f2f2] font-semibold  text-[#002b33]">
                Xiaomi
              </h2>
              <h4 className=" text-2xl dark:text-[#f2f2f2]  font-thin pt-3 text-[#002b33]">
                Redmi 9
                <span className=" dark:text-[#f2f2f2]  font-thin ">
                  pictures
                </span>
              </h4>
              ...
              <div className="pt-6">
                <div className=" flex space-x-2  pt-3">
                  ...
                  <p className=" text-1xl font-normal dark:text-[#f2f2f2] text-[#00000c]">
                    194g, 9mm thickness
                  </p>
                </div>
                ...
                <div className=" flex space-x-2  pt-3">
                  ...
                  <p className=" text-1xl font-normal text-[#00000c] dark:text-[#f2f2f2]">
                    64GB/128GB storage
                  </p>
                </div>
                <div className=" flex space-x-2  pt-3">
              ...
              <button className="mt-6  text-2xl dark:bg-[#555555] dark:hover:bg-[#f2f2f2] dark:hover:text-[#4e4e4e] text-[#f2f2f2] hover:bg-[#002b3373] bg-[#002b33] py-2 px-16 rounded-full">
                $ 138
              </button>
            </div>
          </div>
          <div className=" bg-[#ff9580] dark:bg-[#1f1f1f] py-20 px-10 overflow-hidden relative ">
            ...
            />
            <div>
              <h2 className=" text-5xl  font-semibold  text-[#151515] dark:text-[#f2f2f2]">
                Apple
                <span className=" text-2xl dark:text-[#f2f2f2]  font-normal  text-[#151515]">
                  (iphone)
                </span>
              </h2>
              <h4 className=" text-2xl  font-thin pt-3 dark:text-[#f2f2f2] text-[#151515]">
                15 Pro max
              </h4>
              ...
              <button className="mt-6  text-2xl dark:bg-[#555555] dark:hover:bg-[#f2f2f2] dark:hover:text-[#4e4e4e] text-[#f2f2f2] hover:bg-[#6d23156b] bg-[#330800] py-2 px-16 rounded-full">
                $ 999
              </button>
            </div>
          </div>
...
export default productLightData;
