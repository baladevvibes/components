...
import productLightData from "../productLightData";
...
export default function EcommerceProduct() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: productData[0]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: productLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Ecommerce product this section to highlight the product and sales. This session gives more attraction for the users.`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/product/ecommerce-product/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <section>
                    <div className={` grid py-20 ${xlScreen? `grid-cols-2`: ``} ${lgScreen? `grid-cols-1`:``} ${mdScreen? `grid-cols-1`: ``} ${smScreen? `grid-cols-1`: ``} ${responsiveState? ``: `lg:grid-cols-2 lge:grid-cols-2 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1`} `}>
                      <div className=" bg-[#8fa8ae] dark:bg-[#151515] py-20 px-10 overflow-hidden relative ">
                        <img
                          src={`../../Image/overall/product/redmi.webp`}
                          alt="redmi"
                          className={` ${xlScreen? `-right-10`: ``} ${lgScreen? `-right-10`:``} ${mdScreen? `right-20`: ``} ${smScreen? `hidden`: ``} ${responsiveState? ``: `sm:hidden lg:-right-10 lge:-right-52 md:right-20 mdsm:right-10`}  top-20 rotate-[340deg] absolute h-[350px] `}
                        />
                        <div>
                      ...
                      <div className=" bg-[#ff9580] dark:bg-[#1f1f1f] py-20 px-10 overflow-hidden relative ">
                        <img
                          ...
                          alt="redmi"
                          className={` ${xlScreen? `-right-10  `:``} ${lgScreen? `-right-10  `:``} ${mdScreen? `right-10 `:``} ${smScreen? `hidden `:``} ${responsiveState? ``: `sm:hidden lg:-right-10 lge:-right-52 md:right-10 mdsm:right-10`}  top-20 rotate-[340deg] absolute h-[350px] `}
                        />
                        <div>
