  ...
  return (
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        ...
        <div className={` grid ${xlScreen ? `grid-cols-4 gap-10`: ""}  ${mdScreen? `grid-cols-2 gap-6 `: ``}  ${lgScreen? `grid-cols-3 gap-10`: ``} ${smScreen? `grid-cols-1 gap-4`: ``} ${responsiveState? ``: `lg:grid-cols-4  lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 lg:gap-10 lge:gap-10 md:gap-4 mdsm:gap-4 sm:gap-4 `} px-4`}>
          <div class="bg-white sm:px-4 px-7 py-5 border-[1px]  border-[#e8e8e8]  rounded-lg ">
            <div style={{background :`${color?.hex}`}} class=" ml-2 my-2 h-[70px] relative w-[70px] bg-[#00bc9538]  opacity-50 rounded-full">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
