...
export default function SimpleFooterDesign() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Simple Footer design  and with clean design and proper color code. It is fully responsive.`}
          section_name={`footer`}
          using_font="Volkhov"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/footer/simple-footer-design/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
      ...
      <div className="pb-20 my-20 bg-[#f2f2f2] border-[#ccc] border-t">
        <div className="container mx-auto px-6">
          <div className={`grid ${xlScreen?`grid-cols-2`:``} ${lgScreen?`grid-cols-2`:``} ${mdScreen?`grid-cols-2`:``} ${smScreen?`grid-cols-1`:``}  ${responsiveState?``:`grid-cols-2  sm:grid-cols-1`}   `}>
            <h6 className={` text-[#5a5a5a] ${smScreen?`flex justify-center`:``} ${responsiveState?``:`sm:flex sm:justify-center`}  Volkhov text-[16px] pt-10`}>
              © 2024 makecomponents, Inc. All rights reserved.
            </h6>
            <div className={`flex ${xlScreen?`justify-end`:``} ${lgScreen?`justify-end`:``} ${mdScreen?`justify-end`:``} ${smScreen?`justify-center`:``} ${responsiveState?``:`justify-end sm:justify-center`} `}>
              <div className="pt-10  ">
