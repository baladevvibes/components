...
export default function LandingPageFooterPre() {
  return (
    <div className=" py-10">
      ...
      <div className=" sticky z-50 top-2 py-4 grid grid-cols-2 sm:px-4  px-10 pb-10">
        <div className=" ">
          <a href="/footer/landing-page-footer">
      ...
      <footer>
        <div className={`mt-4 bg-[#2b4a44] py-16`}>
          <div className={` container mx-auto sm:px-4`}>
            ...
            <div className={` grid grid-cols-5 sm:grid-cols-1 pt-10 pb-4`}>
              <div className={` col-span-2 sm:col-span-full`}>
                <div className={` sm:block   flex  sm:space-x-0 space-x-5 `}>
                  <div className={` flex`}>
                    <svg
                      stroke="currentColor"
                      fill="none"
              ...
              <div className={` col-span-3`}>
                <div
                  className={` flex justify-end sm:justify-center sm:pt-4 space-x-6`}
                >
                  <div>
                    {" "}
                    <svg
