...
import ThemeSkeletonData from "../ThemeSkeletonData";
...
export default function BlogSkeletonTailwind() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: SkeletonData[1]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: ThemeSkeletonData[1]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
  ...
  useEffect(() => {
    setCount(1);
    var removeComponents = "045";
    var tagName = "skeleton";
    var newData = [];
    data.forEach((el) => {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Blog skeleton tailwind CSS it loading and make performance good looking onloading view.`}
          section_name={`skeleton`}
          using_font="none"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/skeleton/blog-skeleton-tailwind/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
          ...
          >
            {code ? (
              ...
              <>
                ...
                >
                  <div className=" container px-4 mx-auto dark:bg-[#1e1e1e] py-[150px]">
                  <div className="px-4 container mx-auto">
        <section>
          <div className={`grid ${xlScreen? `grid-cols-4`: ``} ${lgScreen? `grid-cols-4`: ``} ${mdScreen? `grid-cols-2`: ``} ${smScreen? `grid-cols-1`: ``} ${responsiveState? ``:` lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1`}  gap-4`}>
