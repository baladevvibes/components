const SkeletonData = [
  {
    ...
    htmlcode: ` <div class="">
      <div class=" container px-4 mx-auto py-[200px]">
          ...
          <table class=" w-full">
            <thead class=" bg-[#f2f2f2] ">
              <tr class=" border-[1px] border-[#ccc]">
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-24 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-48 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-48 mb-4"></div>
                </td>
            ...
            <tbody>
              <tr class=" border-[1px] border-t-0 border-[#ccc]">
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-10 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-32 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-32 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-14 mb-4"></div>
                </td>
                <td>
                  <div class="h-2.5 bg-[#cccccc] mx-4  rounded-full mt-4 w-14 mb-4"></div>
                </td>
        ...
        <section>
          <div class=" grid lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 gap-4">
            <div role="card" class=" animate-pulse">
              <div class="h-48 w-full bg-[#cccccc]  flex justify-center items-center  rounded-lg mb-4">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
              ...
              <div class="h-2 bg-[#cccccc]  rounded-full  max-w-full mb-2.5"></div>
              <div class="h-2 bg-[#cccccc]  rounded-full  max-w-full mb-2.5"></div>
              <div class="h-2 bg-[#cccccc]  rounded-full  max-w-full mb-2.5"></div>
            </div>
            <div role="card" class=" animate-pulse">
              ...
              <div class="h-2.5 bg-[#cccccc] mt-2 rounded-full  w-48 mb-4"></div>
              <div class="h-2 bg-[#cccccc]  rounded-full  max-w-full mb-2.5"></div>
              <div class="h-2 bg-[#cccccc]  rounded-full  max-w-full mb-2.5"></div>
            </div>
            <div role="card" class=" animate-pulse">
