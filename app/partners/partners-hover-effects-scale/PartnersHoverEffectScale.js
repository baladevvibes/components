...
export default function PartnersHoverEffectScale() {
  ...
  useEffect(() => {
    setCount(1);
    var removeComponents = "009";
    var tagName = "partners";
    var newData = [];
    data.forEach((el) => {
              ...
              <>
                ...
                >
                  <div className={` bg-[#f2f2f2] my-32`}>
                    <section
                      className={` container sm:overflow-hidden mx-auto py-16`}
                    >
                      <div
                        className={` grid ${xlScreen ? ` grid-cols-7` : ``} ${
                          lgScreen ? ` grid-cols-7` : ``
                        } ${mdScreen ? ` grid-cols-4` : ``} ${
                          smScreen ? ` grid-cols-2` : ``
                        } ${
                          responsiveState
                            ? ``
                            : `lg:grid-cols-7 lge:grid-cols-7 md:grid-cols-4 mdsm:grid-cols-4 sm:grid-cols-2`
                        }   gap-2`}
                      >
                        <div>
                          <img
