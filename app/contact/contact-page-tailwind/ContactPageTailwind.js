...
import contactLightData from "../contactLightData";
...
export default function ContactPageTailwind() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: contactData[1]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: contactLightData[0]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Contact page tailwind css and with clean design proper color code. It fully responsive.`}
          section_name={`contact`}
          using_font="Catamaran"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/contact/contact-page-tailwind/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
        ...
        <section>
          <div className={` grid ${xlScreen? `grid-cols-5 gap-10`: ``} ${lgScreen? `grid-cols-5 gap-10`: ``} ${mdScreen? `grid-cols-1 gap-0`: ``} ${smScreen? `grid-cols-1 gap-0`: ``} ${responsiveState? ``:`lg:grid-cols-5  lge:grid-cols-5 md:grid-cols-1 mdsm:grid-cols-1 sm:grid-cols-1 lg:gap-10 lge:gap-10 md:gap-0 mdsm:gap-0 sm:gap-0`}  h-full `}>
            ...
            <div className=" col-span-3  px-4 h-full">
              <div className="h-full">
                <form className=" block">
                  <h3 className={` dark:text-[#fcfcfc] text-[#646076] catamara  pb-4 ${xlScreen? `pt-10  mt-0 text-4xl`: ``} ${lgScreen? `pt-10  mt-0 text-4xl`: ``} ${mdScreen? `pt-24  mt-10 text-3xl`: ``}  ${smScreen? `pt-24  mt-10 text-3xl`: ``} ${responsiveState? ``:`lg:pt-10 lge:pt-10 md:pt-24 mdsm:pt-24 sm:pt-24 lg:mt-0 lge:mt-0 md:mt-10 mdsm:mt-10 sm:mt-10lg:text-4xl lge:text-4xl md:text-3xl mdsm:text-3xl sm:text-3xl`}  `}>
                    Contact us
                  </h3>
