...
export default function TeamSectionDesign() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Team section design example and with clean design and proper color code. It is fully responsive.`}
          section_name={`team`}
          using_font="no using "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/teams/team-section-design/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
      ...
      <div className="">
        ...
        <div className={` grid  ${xlScreen?`grid-cols-4`:``}  ${lgScreen?`grid-cols-3`:``}  ${mdScreen?`grid-cols-2`:``} ${smScreen?`grid-cols-1`:``} ${responsiveState ?``:`lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-3 mdsm:grid-cols-2 sm:grid-cols-1`} `}>
