...
export default function SemiCardDesign() {
  ...
  return (
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          title={`Semi Card Design `}
          des={`This component create on 14/June/2024 using CSS framework tailwindcss. It fully
              responsive component.`}
          section_name={`Card`}
          using_font=" DM Serif Text Regular, Cormorant Garamond Light "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  <a href="/card/semi-card-design/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                    ...
                    <div className={` grid  ${xlScreen ? ` grid-cols-4 `: ``} ${lgScreen? ` grid-cols-2 px-10`:``} ${mdScreen ? `  grid-cols-2 px-10`: ``} ${smScreen ? ` grid-cols-1 px-10`:``} ${responsiveState ? ``:`lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 `} gap-10`}>
                      <div>
                        ...
                        <div className=" bg-[#002200] p-6 pb-8">
                          ...
                          <p className=" text-[#fff] text-center text-[20px] cormorant-garamond-light  pt-2">
                            This characteristic makes them exceptionally
                            low-maintenance.
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className=" bg-[#002200] p-6 pb-8">
                          ...
                          <p className=" text-[#fff] text-center text-[20px] cormorant-garamond-light  pt-2">
                            growing into impressive that can add a touch of
                      ...
                      <div>
                        ...
                        <div className=" bg-[#002200] p-6 pb-8">
                          ...
                          <p className=" text-[#fff] text-center text-[20px] cormorant-garamond-light  pt-2">
                            Their impressive, large foliage adds a dramatic and
                            exotic touch to any home decor.
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className=" bg-[#002200] p-6 pb-8">
                          ...
                          <p className=" text-[#fff] text-center text-[20px] cormorant-garamond-light  pt-2">
                            It's believed to bring good luck and prosperity,
