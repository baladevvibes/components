...
export const metadata = {
  ...
  description:
    ...
    keywords:"card section,free components,free code, make components, make component, Preview",
  openGraph: {
    title: "Three Grid card Template Preview",
    description: "This component create using CSS framework tailwindcss. It full responsive component. This template used for card section Preview",
    ...
    images: [
      ...
      },
      {
        ...
        width: 800,
        height: 600,
        alt: "Three Grid card Template Preview",
      },
    ],
    locale: "en_US",
    type: "website",
