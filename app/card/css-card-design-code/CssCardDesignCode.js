...
export default function CssCardDesignCode() {
  ...
  const files = {
    "app.js": {
      ...
      name: "app.js",
      language: "javascript",
      value: cardData[8]?.htmlcode,
    },
    "darkThemeCode.js": {
      _id: 1,
      name: "darkThemeCode.js",
      language: "javascript",
      value: cardLightData[2]?.htmlcode,
    },
    "index.css": {
      _id: 2,
      name: "index.css",
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`css card design code example and with clean design and proper color code. It is fully responsive.`}
          section_name={`card`}
          using_font="NewsCycle "
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href={`/card/css-card-design-code/preview`}>
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
            ...
            {tailwind ? (
              ...
              <>
                <div
                  className={` ${
                    smScreen
                      ? `  w-[440px] h-auto overflow-auto mx-auto   px-20 `
                      : `${
                          mdScreen
        ...
        <div className=" container px-4 mx-auto">
          <div className={`gap-6 grid ${xlScreen? `grid-cols-4`:``} ${lgScreen? `grid-cols-4`:``} ${mdScreen? `grid-cols-2`:``} ${smScreen? `grid-cols-1`:``} ${responsiveState ? ``:`lg:grid-cols-4 lge:grid-cols-4 md:grid-cols-3 mdsm:grid-cols-2 sm:grid-cols-1`}  `}>
            ...
            <div className="group relative">
              ...
              <img
                ...
                alt="Australia"
                className="mt-8 h-[350px] rounded-2xl  w-full sm:w-[450px] object-cover"
              />
            </div>
            <div className="group relative">
              <div className=" cursor-pointer absolute top-0 z-10 w-full hidden  group-hover:block   duration-300   h-[350px] bg-gradient-to-t from-[#8338EC]  rounded-2xl">
