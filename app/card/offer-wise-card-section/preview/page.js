        ...
        <div className={` grid lg:grid-cols-5 lge:grid-cols-5 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 gap-2 p-2`}>
          <div className={` col-span-2 `}>
            <div className={` group relative `}>
              <div
                className={` cursor-pointer transition delay-300  from-[#ff8936b8] to-[#0025ca] bg-gradient-to-t   flex justify-center items-center absolute top-0 h-full w-full p-10 `}
              >
