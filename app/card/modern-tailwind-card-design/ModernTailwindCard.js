...
export default function ModernTailwindCard() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Modern tailwind card design and with clean design and proper color code. It is fully responsive.`}
          section_name={`Card`}
          using_font="Fira font"
        />
            ...
            >
              ...
              <div className={` flex justify-end`}>
                ...
                <div  onClick={handleCode} className={` group`}>
                  ...
                  <a href="/card/modern-tailwind-card-design/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
                ...
                >
                  <div className="py-20">
                    <div className="container mx-auto">
                      <div className={`grid px-4 ${xlScreen?`grid-cols-3`:``} ${lgScreen?`grid-cols-2`:``} ${mdScreen?`grid-cols-2`:``} ${smScreen?`grid-cols-1`:``} ${responsiveState?``:`lg:grid-cols-3  lge:grid-cols-3 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1`}  gap-10`}>
                        <div className={` ${xlScreen?`pt-0`:``} ${lgScreen?`pt-0`:``} ${mdScreen?`pt-10`:``} ${smScreen?`pt-16`:``} ${responsiveState?``:`lg:pt-0 lge:pt-0 mdsm:pt-0 md:pt-10 sm:pt-16`} `}>
                          <img
