...
export default function MordernCardDesignTailwindCss() {
    ...
    <div className="bg-[rgb(255 255 255)]">
      ...
      <div className={`pt-[100px] container mx-auto px-2 sm:px-3`}>
        <ComponentsHeader
          ...
          des={`Mordern card design tailwind css and with clean design and proper color code. It is fully responsive.`}
          section_name={`card`}
            ...
            >
              ...
              <div className={` flex justify-end`}>
                <div className={` flex space-x-5`}>
                  ...
                  <a href="/card/modern-card-design-tailwind-css/preview">
                    <div className={` group`}>
                      <div
                        className={` p-1.5 border  border-[#ccc]  group-hover:bg-secondary  cursor-pointer  rounded-md`}
                      >
        ...
        <div className="container mx-auto px-4">
          <div className={`grid   ${lgScreen?`grid-cols-3`:``} ${xlScreen?`grid-cols-3`:``}  ${mdScreen?`grid-cols-2`:``} ${smScreen?`grid-cols-1`:``} ${responsiveState?``:` lg:grid-cols-3 lge:grid-cols-3 md:grid-cols-2 mdsm:grid-cols-1 sm:grid-cols-1`} gap-10`}>
            <div>
            <img
