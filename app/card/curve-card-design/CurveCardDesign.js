...
export default function CurveCardDesign() {
            ...
            {code ? (
              <>
                ...
                <button
                  name="darkThemeCode"
                  className={` ${
                    fileName === "darkThemeCode.js" ? `bg-primary` : ` bg-[#f19c1c8a]`
                  }   rounded-t-lg py-2  px-4 mr-2`}
                ...
                >
                  <div className=" relative  py-20 dark:bg-secondary ">
                    <section className="container mx-auto">
                      <div className={` grid  ${xlScreen? ` grid-cols-3`: ``} ${lgScreen? ` grid-cols-3`: ``} ${mdScreen? ` grid-cols-2`:``} ${smScreen ? `grid-cols-1`: ``} ${responsiveState ? ``: `lg:grid-cols-3 lge:grid-cols-3 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1`}  px-4 gap-10`}>
                        <div>
                          ...
                          <div className="">
                            ...
                            <p className="pt-2 text-[#5a5a5a] dark:text-[#fff]  roboto">
                              Modern architecture prioritizes the functionality
                              of spaces, often embracing minimalist designs.
                              This approach emphasizes clean lines, open floor
                              plans, and the use of materials like steel, glass,
                              and concrete to create efficient and
                        ...
                        <div>
                          ...
                          <div className="">
                            ...
                            <p className="pt-2 text-[#5a5a5a] dark:text-[#fff]  roboto">
                              ...
                              architecture. Architects incorporate eco-friendly
                              materials, energy-efficient systems, and green
                              building techniques to reduce environmental
                              impact. Innovations such as green roofs, solar
                              panels, and passive heating and cooling systems
                              are commonly integrated into modern designs.
                            </p>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className=" ">
                            ...
                            <p className="pt-2 text-[#5a5a5a] dark:text-[#fff]  roboto">
                              ...
                              influenced modern architecture. Digital design
                              tools and software, such as Building Information
                              Modeling (BIM), allow architects to create more
                              precise and complex structures.
                            </p>
                          </div>
                        </div>
                      </div>
